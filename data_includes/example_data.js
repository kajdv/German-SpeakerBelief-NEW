...
//PennController.GetTable( "GER-datasource-Sp_bel.csv" );

PennController.FeedItems( PennController.GetTable( "GER-datasource-Sp_bel.csv" ).setLabel("Expt"),//.filter("Expt","experiment"),
    (item) => PennController(
        newTimer("blank", 1000)
            .start()
            .wait()
